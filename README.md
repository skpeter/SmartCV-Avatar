...
SmartCV-Avatar is a tool designed to provide data on Avatar Legends: The Fighting Game without the need for installing mods on your game, or the need for a powerful PC to read game data in real time. 
...
- Your copy of Avatar Legends: The Fighting Game must be in **English**. Support for other languages is being looked into.
...
- Installing the CPU version is very easy. Just download the compiled release.zip [here](https://github.com/skpeter/SmartCV-Avatar/releases).
